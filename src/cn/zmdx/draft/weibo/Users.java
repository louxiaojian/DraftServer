package cn.zmdx.draft.weibo;

import java.util.List;

import cn.zmdx.draft.weibo.model.PostParameter;
import cn.zmdx.draft.weibo.model.WeiboUser;
import cn.zmdx.draft.weibo.model.UserCounts;
import cn.zmdx.draft.weibo.model.WeiboException;
import cn.zmdx.draft.weibo.util.WeiboConfig;
...
public class Users extends Weibo {
	 ...
	 * @since JDK 1.5
	 */
	public WeiboUser showUserById(String uid) throws WeiboException {
		return new WeiboUser(client.get(
	 ...
	 * @since JDK 1.5
	 */
	public WeiboUser showUserByScreenName(String screen_name) throws WeiboException {
		return new WeiboUser(client.get(
				WeiboConfig.getValue("baseURL") + "users/show.json",
	 ...
	 * @since JDK 1.5
	 */
	public WeiboUser showUserByDomain(String domain) throws WeiboException {
		return new WeiboUser(client.get(
