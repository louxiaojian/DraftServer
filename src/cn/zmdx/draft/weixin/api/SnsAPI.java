package cn.zmdx.draft.weixin.api;
...
public class SnsAPI extends BaseAPI {
	...
	public static void main(String[] args) {
		String openid="oWLVJwBLrtXwN3AYbGnWr5xIeGwU";
		String access_token="OezXcEiiBSKSxW0eoylIeEOs8NHSxUsdIaEMOLovd3pKP_XWOvup2xOsMlrZFDeQbgM0EBmTAjIkcO164ukGbreRb9xAIpUaeIT0zNrmR5LnkJIxTOdHVjCBiisFsr_pVd8sFF4kePwtU6JghUAK9Q";
		//		SnsAPI.oauth2AccessToken(appid, secret, code)
		WeiXinUser user=SnsAPI.userinfo(access_token, openid, "zh_CN");
...
/**	public static SnsToken oauth2ComponentRefreshToken(String appid,String refresh_token,String component_appid,String component_access_token){
	 ...
	 * @return
	 */
	public static WeiXinUser userinfo(String access_token,String openid,String lang){
		HttpUriRequest httpUriRequest = RequestBuilder.post()
