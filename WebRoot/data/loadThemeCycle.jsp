...
%>
<body id="activity-detail" onload="addViews()" class="zh_CN " style="background-color: white;">
	<div class="rich_media_day">
	<div id="title" class="rich_media_meta_list" style="text-align: left;width: 100%;height:30%;background-color: #e8894f">
...
<%--		</p>--%>
	...
	<div class="rich_media_inner_day">
		<div id="page-content">
			<div id="img-content">
